...
from .signals import bulk_create, bulk_delete
...
class FollowManager(models.Manager):
    ...
    def create_batch(self, users, target):
        ...
        bulk_create.send(sender=self.model, users=users, target=target)
    ...
    def delete_batch(self, users, target):
        ...
        bulk_delete.send(sender=self.model, users=users, target=target)
